::DISCLAIMER: this tool can be used for free, the credits to JamFlux and other author must be visible where the ROM has been published
@echo off
cls
...
set author=[by JamFlux]
set bins=bins
:::finding architcture:::
reg Query "HKLM\Hardware\Description\System\CentralProcessor\0" | find /i "x86" > NUL && set cpu=32 || set cpu=64
if %cpu%==64 (
set cpu=64bits
) else (
set cpu=32bits
)
if %cpu%==32bits set bins=bins\binsX32
:::::::::::::::::::::::::
set cecho=%bins%\cecho.exe
set busybox=%bins%\busybox.exe

:know_winver
for /f "tokens=4-7 delims=[.] " %%i in ('ver') do (if %%i==Version (set build=%%l) else (set build=%%k)) & set wos=%%i.%%j
if "%wos%" == "5.1" set wos= XP
if "%wos%" == "6.0" set wos=VIS
if "%wos%" == "6.1" set wos=7.0
if "%wos%" == "6.2" set wos=8.0
if "%wos%" == "6.3" set wos=8.1
if "%wos%" == "10.0" set wos= 10
:dragNdrop
if exist *.txt del *.txt > nul
echo ----------------------------------------------->> log.txt
echo -----  S.U.R. Tool %author% started  ----- >> log.txt
echo -----            %time%             ----- >> log.txt
echo ----- Windows: %wos% %cpu% - build: %build% ----- >> log.txt
echo ----------------------------------------------->> log.txt
title %app_name% [v2.0.4] [%cpu%] %author%
if (%1)==() goto start0
mode con: cols=80 lines=16
if exist 01-Project rmdir /q /s
if (%~x1)==(.xz) (
...
if exist system_fs_config move /y system_fs_config 01-Project\temp\system_fs_config >nul 2>nul
if exist system_file_contexts move /y system_file_contexts 01-Project\temp\system_file_contexts >nul 2>nul
if exist system_size.txt move /y system_size.txt 01-Project\temp\system_size >nul 2>nul
...
set /p size=<"01-Project\temp\system_size"
...
echo         ***************************************************************
echo.
%cecho%  	-Can't continue, {04}[file.list]{#} is missing
echo.
echo.
...
if exist %file% echo ---- The selected ROM's zip file is: >> log.txt
if exist %file% echo      %file% >> log.txt
call :make_dirs
cls
echo.
echo         ***************************************************************
...
::<---commands
move /y 01-Project\vendor_size.txt 01-Project\temp\vendor_size >nul 2>nul
if exist 01-Project\temp\vendor_size set /p vendor_size=<"01-Project\temp\vendor_size"
...
if exist 01-Project\1-Sources\vendor_fs_config move /y 01-Project\1-Sources\vendor_fs_config 01-Project\temp\vendor_fs_config >nul 2>nul
move /y 01-Project\1-Sources\vendor_file_contexts 01-Project\temp\vend_file_contexts >nul 2>nul
...
:Extract_SYS
echo ---- imgextractor.exe:  %time% >> log.txt
echo ---- Extracting ROM's image files: >> log.txt
...
echo         ***************************************************************
echo.
%cecho%  	-Unpacking {0a}odm{#} ext4 image to {0a}folder{#} ...
echo.
echo.
%bins%\imgextractor 01-Project\1-Sources\odm.img 01-Project\odm >nul 2>nul >>log.txt
if not exist 01-Project\odm %bins%\imgextractor2 01-Project\1-Sources\odm.img 01-Project\odm >nul 2>nul
if exist 01-Project\odm_statfile.txt move /y 01-Project\odm_statfile.txt 01-Project\temp\odm_fs_config >nul
if exist 01-Project\1-Sources\odm_file_contexts !busybox! rm -rf 01-Project\1-Sources\odm_file_contexts >nul
)
if exist 01-Project\1-Sources\product.img (
cls
echo.
echo         ***************************************************************
%cecho% 	-{06}Welcome to S.U.R.{#} 			          {03}[by JamFlux]{#}
...
echo         ***************************************************************
echo.
%cecho%  	-Unpacking {0a}product{#} ext4 image to {0a}folder{#} ...
echo.
echo.
%bins%\imgextractor 01-Project\1-Sources\product.img 01-Project\product >nul 2>nul >>log.txt
if not exist 01-Project\product %bins%\imgextractor2 01-Project\1-Sources\product.img 01-Project\product >nul 2>nul
if exist 01-Project\product_statfile.txt !busybox! rm -rf 01-Project\product_statfile.txt >nul
if exist 01-Project\1-Sources\product_fs_config move /y 01-Project\1-Sources\product_fs_config 01-Project\temp\product_fs_config >nul
if exist 01-Project\1-Sources\product_file_contexts move /y 01-Project\1-Sources\product_file_contexts 01-Project\temp\product_file_contexts >nul 2>nul
)
...
echo         ***************************************************************
echo.
%cecho%  	-Unpacking {0a}system{#} ext4 image to {0a}folder{#} ...
echo.
echo.
%bins%\imgextractor 01-Project\1-Sources\system.img 01-Project\system >nul 2>nul >>log.txt
if not exist 01-Project\system %bins%\imgextractor2 01-Project\1-Sources\system.img 01-Project\system >nul 2>nul
)
if %build% geq 17134 (goto install) else goto continue
:continue
cls
echo.
echo         ***************************************************************
...
echo.
echo.
if exist 01-Project\system_statfile.txt move /y 01-Project\system_statfile.txt 01-Project\temp\system_fs_config >nul
if exist 01-Project\1-Sources\system_fs_config move /y 01-Project\1-Sources\system_fs_config 01-Project\temp\system_fs_config >nul
if exist 01-Project\1-Sources\system_file_contexts move /y 01-Project\1-Sources\system_file_contexts 01-Project\temp\system_file_contexts >nul 2>nul
...
echo         ***************************************************************
echo.
%cecho%  	-Unpacking {0a}vendor{#} ext4 image to {0a}folder{#} ...
echo.
echo.
%bins%\imgextractor 01-Project\1-Sources\vendor.img 01-Project\vendor >nul 2>nul >>log.txt
if not exist 01-Project\vendor %bins%\imgextractor2 01-Project\1-Sources\vendor.img 01-Project\vendor >nul 2>nul
if exist 01-Project\vendor_statfile.txt move /y 01-Project\vendor_statfile.txt 01-Project\temp\vendor_fs_config >nul
if exist 01-Project\1-Sources\vendor_fs_config move /y 01-Project\1-Sources\vendor_fs_config 01-Project\temp\vendor_fs_config >nul
if exist 01-Project\1-Sources\vendor_file_contexts move /y 01-Project\1-Sources\vendor_file_contexts 01-Project\temp\vend_file_contexts >nul 2>nul
)
if exist 01-Project\odm echo      odm image extracted [OK] >> log.txt
if exist 01-Project\product echo      product image extracted [OK] >> log.txt
if exist 01-Project\system echo      system image extracted [OK] >> log.txt
if exist 01-Project\vendor echo      vendor image extracted [OK] >> log.txt
if exist 01-Project\odm_size.txt !busybox! rm -rf 01-Project\odm_size.txt >nul 2>nul
if exist 01-Project\product_size.txt !busybox! rm -rf 01-Project\product_size.txt >nul 2>nul
if exist 01-Project\system_size.txt !busybox! rm -rf 01-Project\system_size.txt >nul 2>nul
if exist 01-Project\vendor_size.txt !busybox! rm -rf 01-Project\vendor_size.txt >nul 2>nul
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
if exist 01-Project\1-Sources\odm.img call :detect_odm_size
if exist 01-Project\1-Sources\product.img call :detect_product_size
if exist 01-Project\1-Sources\system.img call :detect_system_size
if exist 01-Project\1-Sources\vendor.img call :detect_vendor_size
...
::if exist 01-Project\temp\vend_file_contexts type 01-Project\temp\vend_file_contexts >> 01-Project\temp\system_file_contexts
if exist 01-Project\system\system\build.prop echo SAR: System As Root ROM >> 01-Project\temp\SAR
if exist 01-Project\temp\SAR if exist 01-Project\system\system\vendor\bin\hw (
!busybox! rm -rf 01-Project\temp\SAR >nul
call :fc_finder
...
if exist 01-Project\temp\SAR call :fs_generator
if exist 01-Project\1-Sources\odm.img !busybox! rm -rf 01-Project\1-Sources\odm.img >nul 2>nul
if exist 01-Project\1-Sources\odm.new.dat !busybox! rm -rf 01-Project\1-Sources\odm.new.dat >nul
if exist 01-Project\1-Sources\odm.transfer.list !busybox! rm -rf 01-Project\1-Sources\odm.transfer.list >nul
if exist 01-Project\1-Sources\product.img !busybox! rm -rf 01-Project\1-Sources\product.img >nul 2>nul
if exist 01-Project\1-Sources\product.new.dat !busybox! rm -rf 01-Project\1-Sources\product.new.dat >nul
if exist 01-Project\1-Sources\product.transfer.list !busybox! rm -rf 01-Project\1-Sources\product.transfer.list >nul
if exist 01-Project\1-Sources\system.img !busybox! rm -rf 01-Project\1-Sources\system.img >nul 2>nul
...
if exist 01-Project\1-Sources\vendor.img !busybox! rm -rf 01-Project\1-Sources\vendor.img >nul 2>nul
if exist 01-Project\1-Sources\vendor.new.dat !busybox! rm -rf 01-Project\1-Sources\vendor.new.dat >nul
if exist 01-Project\1-Sources\vendor.transfer.list !busybox! rm -rf 01-Project\1-Sources\vendor.transfer.list >nul
if exist 01-Project\1-Sources\system_file_contexts.bin %bins%\sefcontext_decompile -o 01-Project\temp\system_file_contexts 01-Project\1-Sources\system_file_contexts.bin 2>nul
goto ROMs_menu
...
for /r 01-Project\1-Sources %%a in (*.new.dat.br) do (
cls
echo.
echo         ***************************************************************
%cecho% 	-{06}Welcome to S.U.R.{#} 			          {03}[by JamFlux]{#}
...
echo         ***************************************************************
echo.
%cecho%  	-Decompressing {0a}brotli{#} format for {0a}%%~na.br{#} ...
echo.
echo.
%bins%\brotli -dj %%a >nul
echo      Decompressing %%~na.br >> log.txt
)
if exist 01-Project/1-Sources/system.new.dat echo      Extracted system.new.dat [OK] >> log.txt
if exist 01-Project/1-Sources/odm.new.dat echo      Extracted odm.new.dat [OK] >> log.txt
if exist 01-Project/1-Sources/product.new.dat echo      Extracted product.new.dat [OK] >> log.txt
goto un_pack_dat


:un_pack_dat
cd 01-Project\1-Sources
if exist odm.transfer.list move /y odm.transfer.list odm.new.transfer.list >nul 2>nul
if exist product.transfer.list move /y product.transfer.list product.new.transfer.list >nul 2>nul
if exist system.transfer.list move /y system.transfer.list system.new.transfer.list >nul 2>nul
cd %~dp0
echo ---- sdat2img.exe:  %time% -Converting sparse android data image [.DAT] to EXT4 image >> log.txt
for /r 01-Project\1-Sources %%a in (*.new.dat) do (
cls
echo.
echo         ***************************************************************
%cecho% 	-{06}Welcome to S.U.R.{#} 			          {03}[by JamFlux]{#}
...
echo         ***************************************************************
echo.
%cecho%  	-Extracting {0a}ext4{#} image from {0a}%%~na.dat{#} ...
echo.
echo.
%bins%\sdat2img 01-Project/1-Sources/%%~na.transfer.list %%a 01-Project/1-Sources/%%~na.img >>log.txt
echo      Extracting %%~na.dat >> log.txt
)
cd 01-Project\1-Sources
if exist odm.new.img move /y odm.new.img odm.img >nul 2>nul
if exist product.new.img move /y product.new.img product.img >nul 2>nul
if exist system.new.img move /y system.new.img system.img >nul 2>nul
cd %~dp0
if exist 01-Project/1-Sources/system.img echo      Extracted system.img [OK] >> log.txt
if exist 01-Project/1-Sources/odm.img echo      Extracted odm.img [OK] >> log.txt
if exist 01-Project/1-Sources/product.img echo      Extracted product.img [OK] >> log.txt
cd 01-Project\1-Sources
del *.list >nul
del *.new.dat >nul
cd %~dp0
...
if exist 01-Project\temp\system_size !busybox! rm -rf 01-Project\temp\system_size >nul
echo %size% >> 01-Project\temp\system_size
set /p size=<"01-Project\temp\system_size"
::<---commands
goto ROMs_menu
...
%cecho%  	-Format: {0b}!format!{#}  -System size: {0b}!size!{#} -Api: {0b}!api!{#}
echo.
%cecho%  	-DM Verity: {0b}!boot_status!{#}
echo.
echo.
...
if exist 01-Project\1-Sources\system_file_contexts !busybox! rm -rf 01-Project\1-Sources\system_file_contexts >nul 2>nul
if exist 01-Project\temp\system_file_contexts !busybox! rm -rf 01-Project\temp\system_file_contexts >nul 2>nul
::--->commands
%bins%\fc_finder "01-Project" "01-Project\temp\un_file_contexts" "plat_file_contexts|vendor_file_contexts|nonplat_file_contexts"
if exist 01-Project\temp\un_file_contexts !busybox! sort -u < 01-Project\temp\un_file_contexts >> 01-Project/temp/system_file_contexts
if exist 01-Project\temp\un_file_contexts !busybox! rm -rf 01-Project\temp\un_file_contexts >nul 2>nul
if exist 01-Project\temp\system_file_contexts %bins%\dos2unix -q 01-Project\temp\system_file_contexts
::<---commands
if exist 01-Project\temp\system_file_contexts goto rebuild_yes
...
if exist 01-Project\temp\SAR if exist 01-Project\temp\system_file_contexts if exist 01-Project\vendor (
echo      WARNING: the system image can be created because the vendor file_contexts exists >> log.txt
) else (
echo      WARNING: the system image may not be created because the vendor file_contexts is missing. >> log.txt
echo               Please, when unpacking the system also unpack vendor >> log.txt
)
if exist 01-Project\temp\system_file_contexts (goto rebuild_yes) else (goto file_contexts_finder)
:rebuild_yes
if exist 01-Project\system\EnableWSL.bat !busybox! rm -rf 01-Project\system\EnableWSL.bat >nul
if exist 01-Project\temp\system_file_contexts echo      file_contexts exists [OK] >> log.txt
...
echo      Raw image size is:  %size% >> log.txt
if exist 01-Project\temp\payload.info goto make_payload
if "!boot_status!"=="Null" if "!format!"=="system.new.dat" goto make_dat
if "!boot_status!"=="Null" if "!format!"=="system.new.dat.br" goto make_dat_br
...
echo.
echo.
echo      *function: make_payload >> log.txt
::--->commands
if exist 01-Project\temp\SAR (
	echo      Repacking to: %format% format... [SAR] >> log.txt
    %bins%\make_ext4fs -T -1 -S 01-Project/temp/system_file_contexts -C 01-Project\temp\system_fs_config -l %size% -L / -a / -s 01-Project/1-Sources/system.img "01-Project/system/" >nul 2>nul>> log.txt
 ) else ( 
 	echo      Repacking to: %format% format... [Aonly] >> log.txt
    %bins%\make_ext4fs -s -L system -T -1 -S 01-Project\temp\system_file_contexts -C 01-Project\temp\system_fs_config -l %size% -a system 01-Project\1-Sources\system.img 01-Project\system\ >nul 2>nul>> log.txt
 )
 ::<---commands
...
echo.
echo.
echo      *function: make_img_without_zipping >> log.txt
::--->commands
if exist 01-Project\temp\SAR (
	echo      Repacking to: system.img format... [SAR] >> log.txt
    %bins%\make_ext4fs -T -1 -S 01-Project/temp/system_file_contexts -C 01-Project\temp\system_fs_config -l %size% -L / -a / 01-Project/1-Sources/system.img "01-Project/system/" >nul 2>nul>> log.txt
 ) else ( 
...
echo.
echo.
echo      *function: make_img >> log.txt
::--->commands
if exist 01-Project\temp\SAR (
	echo      Repacking to: %format% format... [SAR] >> log.txt
    %bins%\make_ext4fs -T -1 -S 01-Project/temp/system_file_contexts -C 01-Project\temp\system_fs_config -l %size% -L / -a / 01-Project/1-Sources/system.img "01-Project/system/" >nul 2>nul>> log.txt
 	...
 	echo      Repacking to: %format% format... [Aonly] >> log.txt
    %bins%\make_ext4fs -L system -T -1 -S 01-Project\temp\system_file_contexts -C 01-Project\temp\system_fs_config -l %size% -a system 01-Project\1-Sources\system.img 01-Project\system\ >nul 2>nul>> log.txt
 )
 ::<---commands
if not exist 01-Project\1-Sources\system.img echo      Repacking system to: %format% [Failed] >> log.txt
if not exist 01-Project\1-Sources\system.img goto ROMs_menu
...
if exist 01-Project\vendor call :build_vendor2
if exist 01-Project\odm call :build_odm
if exist 01-Project\product call :build_product
::call :img_mover
call :just_zip
goto finish
...
echo.
echo.
echo      *function: make_dat >> log.txt
::--->commands
if exist 01-Project\temp\SAR (
	echo      Repacking to: %format% format... [SAR] >> log.txt
    %bins%\make_ext4fs -T -1 -S 01-Project/temp/system_file_contexts -C 01-Project\temp\system_fs_config -l %size% -L / -a / -s 01-Project/1-Sources/system.img "01-Project/system/" >nul 2>nul>> log.txt
...
if exist 01-Project\odm call :build_odm2
if exist 01-Project\product call :build_product2
::--------------new.dat part--------------::
timeout /t 1 /nobreak >nul
echo ---- img2sdat.exe:  %time% -Repacking to sparse android data image [.new.DAT] >> log.txt
if exist 01-Project\1-Sources\system.img (
%bins%\img2sdat 01-Project\1-Sources\system.img  -o 01-Project\1-Sources -v %version% >> log.txt
...
timeout /t 1 /nobreak >nul
if exist 01-Project\1-Sources\vendor.img (
%bins%\img2sdat 01-Project\1-Sources\vendor.img  -o 01-Project\1-Sources -v %version% -p vendor >> log.txt
if not exist 01-Project\1-Sources\vendor.new.dat echo      Repacking vendor.new.dat [Failed] >> log.txt
if exist 01-Project\1-Sources\vendor.new.dat echo      Repacking vendor.new.dat [OK] >> log.txt
)
timeout /t 1 /nobreak >nul
if exist 01-Project\1-Sources\odm.img (
%bins%\img2sdat 01-Project\1-Sources\odm.img  -o 01-Project\1-Sources -v %version% -p odm >> log.txt
if not exist 01-Project\1-Sources\odm.new.dat echo      Repacking odm.new.dat [Failed] >> log.txt
if exist 01-Project\1-Sources\odm.new.dat echo      Repacking odm.new.dat [OK] >> log.txt
)
timeout /t 1 /nobreak >nul
if exist 01-Project\1-Sources\product.img (
%bins%\img2sdat 01-Project\1-Sources\product.img  -o 01-Project\1-Sources -v %version% -p product >> log.txt
if not exist 01-Project\1-Sources\product.new.dat echo      Repacking product.new.dat [Failed] >> log.txt
if exist 01-Project\1-Sources\product.new.dat echo      Repacking product.new.dat [OK] >> log.txt
)
timeout /t 1 /nobreak >nul
::--------------new.dat part--------------::
...
if exist 01-Project\1-Sources\product.img !busybox! rm -rf 01-Project\1-Sources\product.img >nul
::--->commands
...
if exist 01-Project\odm fsutil file createnew 01-Project\1-Sources\odm.patch.dat 0 >nul
if exist 01-Project\product fsutil file createnew 01-Project\1-Sources\product.patch.dat 0 >nul
::<---commands
call :just_zip
goto finish
...
echo.
echo.
echo      *function: make_dat_br >> log.txt
::--->commands
if exist 01-Project\temp\SAR (
	echo      Repacking to: %format% format... [SAR] >> log.txt
    %bins%\make_ext4fs -T -1 -S 01-Project/temp/system_file_contexts -C 01-Project\temp\system_fs_config -l %size% -L / -a / -s 01-Project/1-Sources/system.img "01-Project/system/" >nul 2>nul>> log.txt
...
::--------------new.dat.br part--------------::
timeout /t 1 /nobreak >nul
if exist 01-Project\1-Sources\system.new.dat (
%bins%\brotli.exe -6 -j -w 24 01-Project\1-Sources\system.new.dat >nul 2>nul
...
timeout /t 1 /nobreak >nul
if exist 01-Project\1-Sources\vendor.new.dat (
%bins%\brotli.exe -6 -j -w 24 01-Project\1-Sources\vendor.new.dat >nul 2>nul
if not exist 01-Project\1-Sources\vendor.new.dat.br echo      Repacking vendor.new.dat.br [Failed] >> log.txt
if exist 01-Project\1-Sources\vendor.new.dat.br echo      Repacking vendor.new.dat.br [OK] >> log.txt
)
timeout /t 1 /nobreak >nul
if exist 01-Project\1-Sources\odm.new.dat (
%bins%\brotli.exe -6 -j -w 24 01-Project\1-Sources\odm.new.dat >nul 2>nul
if not exist 01-Project\1-Sources\odm.new.dat.br echo      Repacking odm.new.dat.br [Failed] >> log.txt
if exist 01-Project\1-Sources\odm.new.dat.br echo      Repacking odm.new.dat.br [OK] >> log.txt
)
timeout /t 1 /nobreak >nul
if exist 01-Project\1-Sources\product.new.dat (
%bins%\brotli.exe -6 -j -w 24 01-Project\1-Sources\product.new.dat >nul 2>nul
if not exist 01-Project\1-Sources\product.new.dat.br echo      Repacking product.new.dat.br [Failed] >> log.txt
if exist 01-Project\1-Sources\product.new.dat.br echo      Repacking product.new.dat.br [OK] >> log.txt
)
timeout /t 1 /nobreak >nul
::--------------new.dat.br part--------------::
if exist 01-Project\1-Sources\system.img !busybox! rm -rf 01-Project\1-Sources\system.img >nul
...
:install
echo ---- decide to add WSL support: >> log.txt
for /l %%N in (30 -1 1) do (
set /a "min=%%N/60, sec=%%N%%60, n-=1"
if !sec! lss 10 set sec=0!sec!
cls
...
echo         ***************************************************************
echo.
%cecho%  	-Add {0a}WSL{#} support. Please, decide:
echo.
echo.
echo  	Y. Yes			N. No
echo.
echo.
choice /c:NY1 /n /m "*       Add support in !min!:!sec! - Please, decide:  " /t:1 /d:1
if not errorlevel 3 goto :break2
)
:break2
if errorlevel 2 (goto add_WSL) else goto continue

:add_WSL
echo      adding Windows Subsystem Linux support >> log.txt
copy /y %bins%\EnableWSL.bat 01-Project\system >nul 2>nul
cls
echo.
echo         ***************************************************************
%cecho% 	-{06}Welcome to S.U.R.{#} 			          {03}[by JamFlux]{#}
...
echo         ***************************************************************
echo.
%cecho%  	-To add {0a}WSL{#}, open {0a}01-Project\system\EnableWSL.bat{#}
echo.
echo.
%cecho%  	-Open using {0a}administrator privileges{#} and follow instructions.
echo.
echo.
%cecho%  	-When the process is finished, press {0a}Enter{#} to continue
echo.
echo.
pause>nul
cls
...
echo.
echo.
if exist 01-Project\1-Sources\system_file_contexts !busybox! rm -rf 01-Project\1-Sources\system_file_contexts >nul
if exist 01-Project\1-Sources\system_fs_config !busybox! rm -rf 01-Project\1-Sources\system_fs_config >nul 2>nul
%bins%\imgextractor 01-Project\1-Sources\system.img 01-Project\system >nul 2>nul >>log.txt
if exist 01-Project\system\EnableWSL.bat !busybox! rm -rf 01-Project\system\EnableWSL.bat >nul
goto continue
...
echo                         used commands: make_ext4fs -s -L vendor -T -1 -S vend_file_contexts -C vendor_fs_config -l %vendor_size% -a vendor vendor.img vendor\ >> log.txt
::--->commands
%bins%\make_ext4fs -s -L vendor -T -1 -S 01-Project\temp\vend_file_contexts -C 01-Project\temp\vendor_fs_config -l %vendor_size% -a vendor 01-Project\1-Sources\vendor.img 01-Project\vendor\ >nul 2>nul >> log.txt
::<---commands
...
echo                         used commands: make_ext4fs -L vendor -T -1 -S vend_file_contexts -C vendor_fs_config -l %vendor_size% -a vendor vendor.img vendor\ >> log.txt
::--->commands
%bins%\make_ext4fs -L vendor -T -1 -S 01-Project\temp\vend_file_contexts -C 01-Project\temp\vendor_fs_config -l %vendor_size% -a vendor 01-Project\1-Sources\vendor.img 01-Project\vendor\ >nul 2>nul >> log.txt
::<---commands
...
:build_odm
if exist 01-Project\temp\odm_size set /p odm_size=<"01-Project\temp\odm_size"
echo ---- make_ext4fs.exe:  %time% -Repacking to EXT4 odm.img >> log.txt
echo                         used commands: make_ext4fs -L odm -T -1 -S file_contexts -C 01-Project\temp\odm_fs_config -l %odm_size% -a odm odm.img odm\ >> log.txt
::--->commands
%bins%\make_ext4fs -L odm -T -1 -S 01-Project\temp\system_file_contexts -C 01-Project\temp\odm_fs_config -l %odm_size% -a odm 01-Project\1-Sources\odm.img 01-Project\odm\ >nul 2>nul >> log.txt
::<---commands
...
:build_product
if exist 01-Project\temp\product_size set /p product_size=<"01-Project\temp\product_size"
echo ---- make_ext4fs.exe:  %time% -Repacking to EXT4 product.img >> log.txt
echo                         used commands: make_ext4fs -L product -T -1 -S file_contexts -C 01-Project\temp\product_fs_config -l %product_size% -a product product.img product\ >> log.txt
::--->commands
%bins%\make_ext4fs -L product -T -1 -S 01-Project\temp\product_file_contexts -C 01-Project\temp\product_fs_config -l %product_size% -a product 01-Project\1-Sources\product.img 01-Project\product\ >nul 2>nul >> log.txt
::<---commands
if exist 01-Project\1-Sources\product.img echo      Repacking product image [OK] >> log.txt
if not exist 01-Project\1-Sources\product.img echo      Repacking product image [FAILED] >> log.txt
goto:eof
...
echo                         used commands: make_ext4fs -L odm -T -1 -S file_contexts -C 01-Project\temp\odm_fs_config -l %odm_size% -a odm odm.img odm\ >> log.txt
::--->commands
%bins%\make_ext4fs -s -L odm -T -1 -S 01-Project\temp\system_file_contexts -C 01-Project\temp\odm_fs_config -l %odm_size% -a odm 01-Project\1-Sources\odm.img 01-Project\odm\ >nul 2>nul >> log.txt
::<---commands
if exist 01-Project\1-Sources\odm.img echo      Repacking odm image [OK] >> log.txt
if not exist 01-Project\1-Sources\odm.img echo      Repacking odm image [FAILED] >> log.txt
goto:eof
...
echo                         used commands: make_ext4fs -L product -T -1 -S file_contexts -C 01-Project\temp\product_fs_config -l %product_size% -a product product.img product\ >> log.txt
::--->commands
%bins%\make_ext4fs -s -L product -T -1 -S 01-Project\temp\product_file_contexts -C 01-Project\temp\product_fs_config -l %product_size% -a product 01-Project\1-Sources\product.img 01-Project\product\ >nul 2>nul >> log.txt
::<---commands
if exist 01-Project\1-Sources\product.img echo      Repacking product image [OK] >> log.txt
if not exist 01-Project\1-Sources\product.img echo      Repacking product image [FAILED] >> log.txt
goto:eof
...
if exist 01-Project\temp\system_file_contexts copy /y 01-Project\temp\system_file_contexts 01-Project\1-Sources >nul 2>nul
cd 01-Project\1-Sources
move /y system_file_contexts file_contexts >nul 2>nul
cd %~dp0
::--->commands
...
if exist 01-Project\1-Sources\system.new.dat.br !busybox! rm -rf 01-Project\1-Sources\system.new.dat.br >nul
if exist 01-Project\1-Sources\vendor.new.dat.br !busybox! rm -rf 01-Project\1-Sources\vendor.new.dat.br >nul
if exist 01-Project\1-Sources\odm.new.dat.br !busybox! rm -rf 01-Project\1-Sources\odm.new.dat.br >nul
if exist 01-Project\1-Sources\product.new.dat.br !busybox! rm -rf 01-Project\1-Sources\product.new.dat.br >nul
if exist 01-Project\1-Sources\system.new.dat !busybox! rm -rf 01-Project\1-Sources\system.new.dat >nul
if exist 01-Project\1-Sources\vendor.new.dat !busybox! rm -rf 01-Project\1-Sources\vendor.new.dat >nul
if exist 01-Project\1-Sources\odm.new.dat !busybox! rm -rf 01-Project\1-Sources\odm.new.dat >nul
if exist 01-Project\1-Sources\product.new.dat !busybox! rm -rf 01-Project\1-Sources\product.new.dat >nul
...
if exist 01-Project\vendor set /p vendor_size=<"01-Project\temp\vendor_size"
...
for /r %vendor%\app %%a in (*.vdex) do (
	...
	cd ..
	if exist vendor_files\classes.dex echo      %%~na.apk deodexed [Passed] >> log.txt
...
for /r fram_files %%a in (*.vdex) do (
	...
	if exist %%~na_classes5.dex move /y %%~na_classes5.dex classes4.dex >nul 2>nul
	cd ..
	if exist fram_files\classes.dex echo      %%~na.jar deodexed [Passed] >> log.txt
...
for /r %system%\app %%a in (*.vdex) do (
	...
	if exist %%~na_classes5.dex move /y %%~na_classes5.dex classes4.dex >nul 2>nul
	cd ..
	if exist app_files\classes.dex echo      %%~na.apk deodexed [Passed] >> log.txt
...
for /r %system%\priv-app %%a in (*.vdex) do (
	...
	if exist %%~na_classes5.dex move /y %%~na_classes5.dex classes4.dex >nul 2>nul
	cd ..
	if exist priv-app_files\classes.dex echo      %%~na.apk deodexed [Passed] >> log.txt
...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:detect_odm_size
for %%a in ("01-Project\1-Sources\odm.img") do set odm_size=%%~za
if not %odm_size%==0 echo %odm_size%>>01-Project\temp\odm_size
goto:eof
:detect_product_size
for %%a in ("01-Project\1-Sources\product.img") do set product_size=%%~za
if not %product_size%==0 echo %product_size%>>01-Project\temp\product_size
goto:eof
:detect_system_size
for %%a in ("01-Project\1-Sources\system.img") do set system_size=%%~za
if not %system_size%==0 echo %system_size%>>01-Project\temp\system_size
goto:eof
:detect_vendor_size
for %%a in ("01-Project\1-Sources\vendor.img") do set vendor_size=%%~za
if not %vendor_size%==0 echo %vendor_size%>>01-Project\temp\vendor_size
goto:eof
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
:fs_generator
::--->commands
if exist 01-Project\temp\system_fs_config (
cd 01-Project\temp
move /y system_fs_config system_fs_config2 >nul 2>nul
cd %~dp0
)
if exist 01-Project\temp\system_fs_config !busybox! rm -rf 01-Project\temp\system_fs_config >nul 2>nul
%bins%\fs_generator 01-Project\1-Sources\system.img >>01-Project\temp\system_fs_config
::<---commands
:fc_finder
::file_contexts maker::
if exist 01-Project\temp\system_file_contexts (
cd 01-Project\temp
move /y system_file_contexts system_file_contexts2 >nul 2>nul
cd %~dp0
)
if exist 01-Project\temp\system_file_contexts !busybox! rm -rf 01-Project\temp\system_file_contexts >nul 2>nul
::--->commands
...
if exist 01-Project\1-Sources\un_file_contexts !busybox! sort -u < 01-Project\1-Sources\un_file_contexts >> 01-Project/temp/system_file_contexts
